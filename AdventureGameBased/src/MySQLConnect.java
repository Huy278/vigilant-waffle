...
public class MySQLConnect {
    ...
    public void createTable() {
    	try {
			...
			statement.executeUpdate("insert into Enemy (name,health,dmgMult, coins, tier) values(\"android\", 300, 2.4, 700, 5); ");
			statement.executeUpdate("insert into Enemy (name,health,dmgMult, coins, tier) values(\"batcoon\", 350, 2.5, 750, 5); ");
			...
			statement.executeUpdate("insert into Boss (name,health,dmgMult, coins, tier) values(\"sea king\", 1000, 6.0, 2400, 3); ");
			statement.executeUpdate("insert into Boss (name,health,dmgMult, coins, tier) values(\"space emperor\", 1050, 7.0, 2700, 4); ");
